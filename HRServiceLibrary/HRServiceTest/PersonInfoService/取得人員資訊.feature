...
Scenario: 取得人員資訊，欄位需要有員工編號、姓名、部門名稱、職稱
	Given 設定的查詢"PsersonCondition"的條件
	| IsIncludeGoAway |
	| true   |
	And 人員為"PersonModel"的資料
...
Scenario: 取得人員資訊，當條件不含離職的人員
	Given 設定的查詢"PsersonCondition"的條件
	| IsIncludeGoAway |
	| false   |
	And 人員為"PersonModel"的資料
	| Empno | Name | Dpt  | JobTitle	| IsGoAway |
	| A02   | 龔柔心  | 0002 | 研究員     | true     |
	| A01   | 陳怡臻  | 0001 | 創辦人     | false    |
	| A03   | 林智仁  | 0002 | 研究經理    | true     |
	And 部門為"DepartMentModel"的資料
	| Dpt | Name | 
	| 0001   | 創辦室  | 
	| 0002   | 研究室  | 
